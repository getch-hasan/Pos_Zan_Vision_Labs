          ...
          <div>
            <div className="flex gap-2 ">
              ...
              <div className='relative inline-block'>
                ...
                {isOpen && (
                  <div className="absolute top-[30px] mt-2 w-60  right-0  p-4 bg-[#7c5cc4] border border-gray-300 shadow-lg rounded-md">
                    {buttons.map((btn, index) => (
                      <button
                        key={index}
                        className="bg-[#7c5cc4] text-white px-4 py-2 rounded-md flex items-center gap-2"
                      >
                        {btn}
                      </button>
                    ))}
